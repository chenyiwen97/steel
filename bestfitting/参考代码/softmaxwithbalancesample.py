...
train_loader = DataLoader(dataset=train_dataset, batch_size=16, sampler=myTrainSample, pin_memory=True)

valid_dataset = ImageData(val_data, path, augmentation=dataAugumentation3, mean=(0.485, 0.456, 0.406),
                          std=(0.229, 0.224, 0.225), subset="train")
...
class Trainer(object):
    ...
    def __init__(self, model):
        self.num_workers = 6
        self.batch_size = {"train": 16, "val": 32}
    ...
    def start(self):
        for epoch in range(self.num_epochs):
            ...
            if val_loss < self.best_loss:
                ...
                torch.save(self.net.state_dict(), "E:/pycharm_project/steel/code/b3unetbalanceseg.pth")
...
if __name__ == '__main__':
    ...
    loss_weight=torch.FloatTensor([1,3,5,1,2]).cuda()
    # loss_weight = torch.FloatTensor([1, 1, 1, 1, 1]).cuda()

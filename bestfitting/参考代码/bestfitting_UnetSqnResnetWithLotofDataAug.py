...
from datasets.datastes import ImageData
from myutils.cal_util import AverageMeter, metric
from myutils.augumentation_util import dataAugumentation2
import shutil
...
def main():
    ...
    train_dataset = ImageData(train_data, path, dataAugumentation2, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225), subset="train")
    train_loader = DataLoader(dataset=train_dataset, batch_size=8, shuffle=True)

    valid_dataset = ImageData(val_data, path, augmentation = dataAugumentation2, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225), subset="train")
...
model_out_dir = "./model/0926UnetSqnResnetWithLotofDataAug"

...
class SEnetUnet(nn.Module):
    def load_pretrain(self, pretrain_file):
        ...
        self.backbone.load_state_dict(torch.load('E:/KAGGLE_STEEL/OneDrive/kaggle/bestfitting/pretrained/se_resnext50_32x4d-a260b3a4.pth', map_location=lambda storage, loc: storage))
    #attention_type
    #none:no attention

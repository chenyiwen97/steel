...
class GGCNN(nn.Module):
    ...
    def __init__(self, input_channels=3):
        ...
        self.class1_output = nn.Conv2d(filter_sizes[5], 1, kernel_size=2)
        self.class2_output = nn.Conv2d(filter_sizes[5], 1, kernel_size=2)
        self.class3_output = nn.Conv2d(filter_sizes[5], 1, kernel_size=2)
        self.class4_output = nn.Conv2d(filter_sizes[5], 1, kernel_size=2)
    ...
    def forward(self, x):
        ...
        class1_output = self.class1_output(x)
        class2_output = self.class2_output(x)
        class3_output = self.class3_output(x)
        class4_output = self.class4_output(x)

        return class1_output, class2_output, class3_output, class4_output

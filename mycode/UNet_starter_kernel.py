...
from albumentations import (HorizontalFlip, ShiftScaleRotate, Normalize,VerticalFlip, Resize, Compose, GaussNoise)
...
def provider(
    ...
    train_df, val_df = train_test_split(df, test_size=0.2, stratify=df["defects"], random_state=69)     ##这里变了
    ...
    def start(self):
        for epoch in range(self.num_epochs):
            ...
            if val_loss < self.best_loss:
                ...
                torch.save(self.net.state_dict(), "./saasa.pth")
...
if __name__ == '__main__':
    ...
    # model = torch.jit.load('E:/pycharm_project/steel/baseline_model/unet_resnet34.pth').cuda()
    # model.eval()
    ...
    model.load_state_dict(torch.load("E:/pycharm_project/steel/code/save_model/model_swa.pth",map_location=lambda storage, loc: storage)["state_dict"])
    model.cuda()
    model.eval()
    ...
    # model_trainer.optimizer=optim.Adam(model_trainer.net.parameters(),lr=1e-5)

...
class Trainer(object):
    ...
    def iterate(self, epoch, phase):
        ...
        print("Loss: %0.4f | acc: %0.4f | pos_acc: %0.4f | neg_acc: %0.4f " % (epoch_loss,acc,pos_acc,neg_acc))
    ...
    def start(self):
        for epoch in range(self.num_epochs):
            ...
            if val_loss < self.best_loss:
                ...
                torch.save(self.net.state_dict(), "./efficientnetcls.pth")

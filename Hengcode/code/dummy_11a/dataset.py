...
DATA_DIR = 'E:/pycharm_project/LB 0.90161/data'
PIC_DIR='E:/data_set/steel'
...
class SteelDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image = cv2.imread(PIC_DIR + '/%s/%s'%(folder,image_id), cv2.IMREAD_COLOR)
